...
export const HIGHLIGHTS: IProject[] = [
  ...
  },
  {
    ...
    {
    name: "Queue Attendance System",
    slug: "queue",
    image: "/projects/queue.png",
    blurImage: "/projects/blur/myokr-blur.jpg",
    description: "An application for managing attendance and auto grading",
    ...
    url: "https://github.com/hamidurrk/lut-fop-attendance-system-local/releases/tag/v0.1.1",
    github: "https://github.com/hamidurrk/lut-fop-attendance-system-local",
    embed:'<iframe width="100%" height="100%" src="https://www.youtube.com/embed/E5iBuQoEfWs?si=3lx4d5Xrf_rG4mIb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    tech: ["python", "ctk", "sqlite", "selenium"],
  },
  {
...
export const PROJECTS: IProject[] = [
  {
    ...
    details: "This project aims to estimate network tower locations using the Mean Shift clustering algorithm based on signal strength measurements collected by a robot at various locations. The software provides visualization tools to analyze signal strength data and identify areas with poor network coverage.",
    gradient: ["#1F6582", "#1ABCFE"],
    url: "https://youtu.be/rho0ssSEc7s",
    github: "https://github.com/hamidurrk/ground-station",
    embed: '<iframe width="100%" height="100%" src="https://www.youtube.com/embed/rho0ssSEc7s?si=tbkcgQwZC38e48o2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    tech: ["python", "sklearn", "yolo", "opencv", "ros", "pandas", "ctk"],
  },
  {
    ...
    details: "Invented an electricity billing system that eliminated non-technical losses by 100% and ensures transparency and immutability.Won a Silver Medal in SDG 12 national teams from 44 countries at the International Blockchain Olympiad 2022 (Hong Kong). Secured Bronze Medal as the youngest developer to secure top national position in the Bangladesh Blockchain Olympiad 2022.",
    gradient: ["#003052", "#167187"],
    url: "https://youtu.be/YftsPNbBj10",
    github: "",
    embed:'<iframe width="100%" height="100%" src="https://www.youtube.com/embed/YftsPNbBj10?si=pl4asKvK8psBcsf6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    tech: ["python", "solidity", "etherium", "ipfs", "ESP32", "cpp", "php", "javascript", "thingspeak"],
  },
  ...
  {
    name: "Python Program Tester",
    slug: "python-program-tester",
    image: "/projects/project_tester.png",
    blurImage: "/projects/blur/myokr-blur.jpg",
    description: "Primarily a project submission testing helper for programming courses",
    details: "A Python program testing application with an integrated terminal, syntax highlighting, real-time file monitoring, and point tracking.",
    gradient: ["#153BB9", "#0E2C8B"],
    url: "https://github.com/hamidurrk/python-project-tester-2025/releases/tag/v1.0.3",
    github: "https://github.com/hamidurrk/python-project-tester-2025",
    embed:'<iframe width="100%" height="100%" src="https://www.youtube.com/embed/2_AaXLsH5NE?si=Z8fwSr4ikwEVKa9L" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    tech: ["python", "tk", "sqlite", "selenium"],
  },
  {
    name: "Pixamon",
    slug: "pixamon",
    image: "/projects/pixamon.png",
    blurImage: "/projects/blur/myokr-blur.jpg",
    description: "Retro style pixel art android game",
    details: "Lutemon is a monster battling and training game where players can create, train, and battle with creatures called Lutemons. The game is built using the LibGDX framework, which provides cross-platform compatibility for Android and desktop environments. You can download the game from GitHub and play it on your Android device.",
    gradient: ["#153BB9", "#0E2C8B"],
    url: "https://github.com/hamidurrk/pixamon-game/releases/tag/v1.0.0",
    github: "https://github.com/hamidurrk/pixamon-game",
    embed:'<iframe width="100%" height="100%" src="https://www.youtube.com/embed/3uMdvgWf3kc?si=bvdknJVSqWMTfYMV" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    tech: ["java"],
  },
  {
    name: "Social Media Scraper",
  ...
  },
  {
    ...
    gradient: ["#153BB9", "#0E2C8B"],
    url: "https://youtu.be/msnqIWiH6DI",
    github: "https://github.com/hamidurrk/epaper-scraper",
    embed:'<iframe width="100%" height="100%" src="https://www.youtube.com/embed/msnqIWiH6DI?si=8HFMykcwo4mufrwr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
  ...
  },
  {
    ...
    details: "Spectre OS is a specialized operating system designed to provide advanced control and debugging capabilities for the Spectre bot. It enables the robot to tweak settings, adjust parameters, and reprogram functionalities on-the-run without connecting to an external computer, which is advantageous in a competitive field. ",
    gradient: ["#153BB9", "#0E2C8B"],
    url: "https://youtu.be/pRV1xqzwm3g",
    github: "https://github.com/hamidurrk/haunt-os",
    embed: '<iframe width="100%" height="100%" src="https://www.youtube.com/embed/pRV1xqzwm3g?si=LQSuy9PhZqpOYnyM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    tech: ["cpp", "arduino", "esp32"],
  },
  ...
  },
  {
    ...
    details: "The hand-glove-like device converts characters into a 3x2 dot matrix braille cell and provides tactile feedback using 6 vibration motors embedded into the fabric of the index and middle fingers of the hand glove. The device is designed to receive strings via Bluetooth, process the data using a microcontroller (ESP32), and deliver haptic feedback to the user.",
    gradient: ["#245B57", "#004741"],
    url: "https://youtu.be/tgz7zx57lec",
    github: "https://github.com/hamidurrk/Assistive-Device-for-Visually-Impaired-People",
    embed:'<iframe width="100%" height="100%" src="https://www.youtube.com/embed/tgz7zx57lec?si=vmqorhk_KcaoqnKU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    tech: ["cpp", "python", "arduino", "esp32"],
  },
...
export const TIMELINE: Array<TimelineNodeV2> = [
  ...
  },
  {
    ...
    size: ItemSize.SMALL,
    subtitle:
      "Assisted in teaching the course at LUT University. Responsibilities included designing questions and conducting laboratory classes, providing one-on-one support, and grading projects.",
  ...
  },
  {
    type: NodeTypes.CHECKPOINT,
    month: "Sept",
    title: "Teaching Assistant | Fundamentals of Programming (Python)",
    size: ItemSize.SMALL,
    subtitle:
      "Assisted in teaching the course at LUT University. Responsibilities included conducting weekly exercise sessions, providing one-on-one support, and grading assignments and projects.",
    image: "/timeline/lut_logo.png",
    slideImage: "/timeline/lut.jpg",
    shouldDrawLine: true,
    alignment: Branch.LEFT,
  },
  {
    type: NodeTypes.CHECKPOINT,
    month: "May",
    title: "Software Engineer | Prime Tech Solutions Ltd.",
    size: ItemSize.SMALL,
    subtitle:
      "Designed & developed Bangladesh's first census-survey data migration and SDMX system of for Govt. Bureau of Statistics. Collaborated with cross‑functional depts of the Bureau.",
    image: "/timeline/ptsl-logo.png",
    slideImage: "/timeline/ptsl-bbs.png",
    shouldDrawLine: true,
    alignment: Branch.LEFT,
  },
  {
